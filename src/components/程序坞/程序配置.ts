...
export const 默认程序 = [
    {name:"访达",icon:访达icon},
    {name:"设置",icon:设置icon},
    {name:"启动台",icon:启动台icon},
    {name:"Safari 浏览器",icon:safarlicon},
    {name:"App Store",icon:AppStoreIcon},
    {name:"地图",icon:地图icon},
    {name:"活动监视器",icon:活动监视器},
    {name:"终端",icon:终端icon},
    {name:"照片",icon:照片icon},
    {name:"提醒",icon:提醒icon},
    {name:"日历",icon:日历icon,date:true},
    {name:"时钟",icon:时钟icon,time:true},
    {name:"废纸篓",icon:废纸篓icon},
]